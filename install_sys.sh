#!/bin/bash
# Never run pacman -Sy on your system! (Here we run it in a live system)
pacman -Sy dialog
...
dialog --no-cancel --inputbox \
    ...
    Enter below the partition size (in Gb) for the Swap. n\n\
...
curl https://raw.githubusercontent.com/lucabol\
